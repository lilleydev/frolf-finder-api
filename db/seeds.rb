...
san_diego = Location.create(city: "San Diego", state: "CA", country: "US")
kit_carson = san_diego.courses.create(name: "Kit Carson", street: "3333 Bearc Valley Pkwy", city: "Escondido", state: "CA", difficulty: 6, mixed_use_park: true)
